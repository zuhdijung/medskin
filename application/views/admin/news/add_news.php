  ...
  <div class="box-body">
    ...
    <?php echo form_open_multipart('');?>
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" rows="3" name="news"><?php echo set_value('news')?></textarea>
        </div>
        <div class="form-group">
          <label>Status News</label>
          <select class="form-control" name="status_news" value="<?php echo set_value('status_news')?>">
