		  ...
		  <div class="container-fluid">
		    ...
		    <div class="navbar-header">
		      <button type="button" onclick="openNav()" class="navbar-toggle cus-navbar-header collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
		        ...
		        <span class="icon-bar cus-icon-bar"></span>
		      	...
		      	<ol class="breadcrumb">
				  <li class="active"><a href="<?php echo base_url('member/home')?>">Home</a></li>
				</ol>
				<div class="right">
		    ...
		    <div class="collapse navbar-collapse" id="navslide">
		      ...
		      <ul class="nav navbar-nav cus-navbar-nav">
		        <li class="active"><a href="<?php echo base_url('member/home')?>"><span class="icon-home"></span>Home<span class="sr-only">(current)</span></a></li>
		        <li><a href="<?php echo base_url('member/view-profile/'.$this->session->userdata('userId'))?>"><span class="icon-profile"></span>Profile</a></li>
		        <li><a href="<?php echo base_url('member/find-doctor')?>"><span class="icon-find"></span>Find Doctor</a></li>
		        <li><a href="<?php echo base_url('member/appointment')?>"><span class="icon-calendar"></span>Appointment</a></li>
		        <li><a href="<?php echo base_url('member/bookmarked')?>"><span class="icon-bookmark"></span>Bookmarked</a></li>
		        <li><a href="<?php echo base_url('member/medical-record')?>"><span class="icon-medical"></span>Medical Record</a></li>
		        <li><a href="<?php echo base_url('member/logout')?>"><span class="icon-logout"></span>Logout</a></li>
		      </ul>
		    </div><!-- /.navbar-collapse -->
		  </div><!-- /.container-fluid -->
		</nav>
