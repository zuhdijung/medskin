...
<div class="position-content">
	<div class="container">
		...
		<div class="row">
			...
			<div class="ms-appointment-booked">
				...
				<div class="container">
					<div class="input-group margin-bottom-xs">
						<input type="text" name="booked_date" class="form-control" placeholder="Select Date" id="datepicker" value="<?php //echo date('d M Y');?>" required>
						  ...
						  <div class="panel panel-default">
						    ...
						    <div id="collapse1" class="panel-collapse collapse in">
						      <div class="panel-body">
									    <div class="time"><input type="radio" name="date" value="10:00" />10:00</div>
									    <div class="time"><input type="radio" name="date" value="10:10" />10:10</div>
									    <div class="time"><input type="radio" name="date" value="10:20" />10:20</div>
									    <div class="time"><input type="radio" name="date" value="10:30" />10:30</div>
									    <div class="time"><input type="radio" name="date" value="10:40" />10:40</div>
									    <div class="time"><input type="radio" name="date" value="10:50" />10:50</div>
									    <div class="time"><input type="radio" name="date" value="11:00" />11:00</div>
									    <div class="time"><input type="radio" name="date" value="11:10" />11:10</div>
									    <div class="time"><input type="radio" name="date" value="11:20" />11:20</div>
									    <div class="time"><input type="radio" name="date" value="11:30" />11:30</div>
									    <div class="time"><input type="radio" name="date" value="11:40" />11:40</div>
									    <div class="time"><input type="radio" name="date" value="11:50" />11:50</div>
						      </div>
						    </div>
						  </div>
						  <div class="panel panel-default">
			...
			<button type="submit" class="btn form-control btn-green-control">BOOK APPOINTMENT <i class="fa fa-arrow-right"></i></button>
			<?php echo form_close();?>
		</div>
		<!-- End of Appointment -->
	</div>
